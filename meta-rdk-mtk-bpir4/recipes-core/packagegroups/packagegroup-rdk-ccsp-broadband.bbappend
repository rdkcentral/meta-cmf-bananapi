...
RDEPENDS:packagegroup-rdk-ccsp-broadband:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'nat46', 'nat46', '', d)}"
RDEPENDS:packagegroup-rdk-ccsp-broadband:append = " mount-nvram"
