...
LICENSE = "Proprietary"
LIC_FILES_CHKSUM = "file://${UNPACKDIR}/git/gsdk/License.txt;md5=9a041f41aad5520b22ab2bb033c11e3c"
...
DEPENDS += "virtual/cross-cc virtual/cross-c++ virtual/libc"
...
do_install() {
    ...
    install -m 0644 ${UNPACKDIR}/bt-host-cpc-hci-bridge.service ${D}${systemd_system_unitdir}
    install -m 0644 ${UNPACKDIR}/bt-host-cpc-hci-bridge-attach.service ${D}${systemd_system_unitdir}
}
