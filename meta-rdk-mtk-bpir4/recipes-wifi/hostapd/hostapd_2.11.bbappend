...
do_install:append() {
    install -m 755 ${UNPACKDIR}/hostapd-2G.conf ${D}${sysconfdir}/hostapd-2G.conf
    install -m 755 ${UNPACKDIR}/hostapd-5G.conf ${D}${sysconfdir}/hostapd-5G.conf
    install -m 755 ${UNPACKDIR}/hostapd-6G.conf ${D}${sysconfdir}/hostapd-6G.conf
